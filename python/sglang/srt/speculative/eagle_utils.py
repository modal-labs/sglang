...
class EagleVerifyInput:
    ...
    def verify(
        ...
        free_cache_loc_cpu = torch.where(evict_mask, model_worker_batch.out_cache_loc, 0).to("cpu", non_blocking=True)
        ...
        model_worker_batch.seq_lens_cpu.add_(self.spec_steps + 1)
